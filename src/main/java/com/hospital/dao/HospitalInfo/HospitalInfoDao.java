...
public interface HospitalInfoDao {
    ...
    List<String> getMzyyList(@Param(value = "schid")String schid, @Param(value = "ampm")String ampm,@Param(value = "schdateStr")String schdateStr);
    List<String> getGhxxList(PbjlxhVo pbjlxhVo);
