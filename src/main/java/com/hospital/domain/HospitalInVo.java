...
public class HospitalInVo {
    ...
    public HospitalInVo(String orgid, String orgname, String alias, String description, String address, String level, String nature, String category, String tel, String web, String state) {
        this.orgid = orgid;
