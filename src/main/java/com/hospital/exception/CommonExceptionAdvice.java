...
import com.hospital.common.ResultModel;
...
public class CommonExceptionAdvice {
    ...
    public ResultModel handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        ...
        return ResultModel.failResultModel("required_parameter_is_not_present");
    }
    ...
    public ResultModel handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        return ResultModel.failResultModel("could_not_read_json");
    }
    ...
    public ResultModel handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResultModel.failResultModel(message);
    }
    ...
    public ResultModel handleServiceException(ConstraintViolationException e) {
        ...
        return ResultModel.failResultModel("parameter:" + message);
    }
    ...
    public ResultModel handleValidationException(ValidationException e) {
        logger.error("参数验证失败", e);
        return ResultModel.failResultModel("validation_exception");
    }
    ...
    public ResultModel handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        return ResultModel.failResultModel("request_method_not_supported");
    }
    ...
    public ResultModel handleHttpMediaTypeNotSupportedException(Exception e) {
        ...
        return ResultModel.failResultModel("content_type_not_supported");
    }
    ...
    public ResultModel handleServiceException(ServiceException e) {
        ...
        return ResultModel.failResultModel("业务逻辑异常：" + e.getMessage());
    }
    ...
    public ResultModel handleException(Exception e) {
        logger.error("通用异常", e);
        return ResultModel.failResultModel("通用异常：" + e.getMessage());
    }
    ...
    public ResultModel handleException(DataIntegrityViolationException e) {
        ...
        return ResultModel.failResultModel("操作数据库出现异常：字段重复、有外键关联等");
    }
}
